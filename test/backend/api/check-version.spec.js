...
describe('checkVersionImmutable', () => {
  it('should throw an ConflictError if version is lower then model version', () => {
    expect(() => checkVersionImmutable(1, new ImmutableAggregateRoot(new AggregateMeta(42, 2)))).toThrow(ConflictError)
  })
  it('should throw an ConflictError if version higher then model version', () => {
    expect(() => checkVersionImmutable(3, new ImmutableAggregateRoot(new AggregateMeta(42, 2)))).toThrow(ConflictError)
  })
  it('should return nothing if version matches', () => {
    expect(checkVersionImmutable(2, new ImmutableAggregateRoot(new AggregateMeta(42, 2)))).toEqual(undefined)
  })
})
